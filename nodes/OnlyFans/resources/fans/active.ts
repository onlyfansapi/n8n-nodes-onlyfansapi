...
export const listActiveFansResource: INodeProperties[] = [
	{
	...
	},
	{
		...
		type: 'collection',
		default: {},
		description: 'Optional filters when listing active fans',
...
export const listActiveFansOperation = {
	name: 'listActiveFans',
	displayName: 'List Active Fans',
	method: 'GET' as const,
	parameters: listActiveFansResource,
